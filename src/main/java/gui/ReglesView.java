...
public class ReglesView {
    ...
    public ReglesView(Pane reglesRoot, Stage primaryStage) {
        ...
        */
        ...
        description4.setFont(Font.loadFont("file:src/main/resources/ARCADE_I.TTF", 10));
        ...
        label5.setFont(Font.loadFont("file:src/main/resources/ARCADE_I.TTF", 20));
        ...
        description5.setFont(Font.loadFont("file:src/main/resources/ARCADE_I.TTF", 10));
        ...
        label6.setFont(Font.loadFont("file:src/main/resources/ARCADE_I.TTF", 20));
        ...
        description6.setFont(Font.loadFont("file:src/main/resources/ARCADE_I.TTF", 10));
        ...
        label7.setFont(Font.loadFont("file:src/main/resources/ARCADE_I.TTF", 20));
        ...
        description7.setFont(Font.loadFont("file:src/main/resources/ARCADE_I.TTF", 10));
        ...
        label8.setFont(Font.loadFont("file:src/main/resources/ARCADE_I.TTF", 20));
        ...
        description8.setFont(Font.loadFont("file:src/main/resources/ARCADE_I.TTF", 10));
        ...
        label9.setFont(Font.loadFont("file:src/main/resources/ARCADE_I.TTF", 20));
        ...
        description9.setFont(Font.loadFont("file:src/main/resources/ARCADE_I.TTF", 10));
        ...
        label10.setFont(Font.loadFont("file:src/main/resources/ARCADE_I.TTF", 20));
        ...
        description10.setFont(Font.loadFont("file:src/main/resources/ARCADE_I.TTF", 10));
