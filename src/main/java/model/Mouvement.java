...
public class Mouvement {
    ...
    public static void north(MazeState maze, Ghost valeurs, String mode) {
        ...
        IntCoordinates co = new IntCoordinates(
                (int) valeurs.getPos().getX(),
                (int) Math.floor(valeurs.getPos().getY())
        );
        ...
        if (!maze.getconfig().getCell(co).northWall() &&
                !maze.getconfig().getCell(co).westWall() &&
                !maze.getconfig().getCell(co).eastWall())
        {
            IntCoordinates vers = manhattan(objectif,
                    co.rightNeighbour(), co.upNeighbour(), co.leftNeighbour()
            );

            if (vers.estEgal(co.leftNeighbour())) {
                dir = Direction.WEST;
            }

            if (vers.estEgal(co.upNeighbour())) {
                dir = Direction.NORTH;
            }

            if (vers.estEgal(co.rightNeighbour())) {
                dir = Direction.EAST;
            }
    ...
    public static void south(MazeState maze, Ghost valeurs, String mode) {
        ...
        IntCoordinates co = new IntCoordinates(
                (int) valeurs.getPos().getX(),
                (int) Math.ceil(valeurs.getPos().getY())
        );
        IntCoordinates objectif = null;
        ...
        if (!maze.getconfig().getCell(co).southWall() &&
                !maze.getconfig().getCell(co).westWall() && !maze.getconfig().getCell(co).eastWall())
        {
            IntCoordinates vers = manhattan(objectif,
                    co.rightNeighbour(), co.downNeighbour(), co.leftNeighbour()
            );
            ...
            if (vers.estEgal(co.downNeighbour())) {
                dir = Direction.SOUTH;
            }
    ...
    public static void east(MazeState maze, Ghost valeurs, String mode) {
        Direction dir = Direction.NONE;
        IntCoordinates co = new IntCoordinates(
                (int) Math.ceil(valeurs.getPos().getX()),
                (int) valeurs.getPos().getY()
        );
        IntCoordinates objectif = null;
        ...
        if (!maze.getconfig().getCell(co).southWall() &&
                !maze.getconfig().getCell(co).eastWall() &&
                !maze.getconfig().getCell(co).northWall())
        {
            IntCoordinates vers = manhattan(objectif,
                    co.rightNeighbour(), co.downNeighbour(), co.leftNeighbour()
            );
                ...
                !maze.getconfig().getCell(co).eastWall())
        {
            ...
            valeurs.setDirection(dir);
                ...
                && !maze.getconfig().getCell(co).southWall())
        {
    ...
    public static void west(MazeState maze, Ghost valeurs, String mode) {
        Direction dir = Direction.NONE;
        IntCoordinates co = new IntCoordinates(
                (int) Math.floor(valeurs.getPos().getX()),
                (int) valeurs.getPos().getY()
        );
        IntCoordinates objectif = null;
        ...
        {
            IntCoordinates vers = manhattan(objectif,
                    co.upNeighbour(), co.downNeighbour(), co.leftNeighbour()
            );
    ...
    public static void none(MazeState maze, Ghost valeurs, String mode) {
        ...
        if (!maze.getconfig().getCell(co).southWall()) {
            if (!maze.getconfig().getCell(co).eastWall() &&
                    !maze.getconfig().getCell(co).westWall())
            {
                IntCoordinates vers = manhattan(objectif,
                        co.leftNeighbour(), co.downNeighbour(), co.rightNeighbour()
                );
            ...
            {
                IntCoordinates vers = manhattan(objectif,
                        co.upNeighbour(), co.downNeighbour(), co.rightNeighbour());
            ...
            {
                IntCoordinates vers = manhattan(objectif,
                        co.leftNeighbour(), co.upNeighbour(), co.rightNeighbour());
    ...
    /**
     * retourner parmis les 2 propositions laquel est la plus proche de l'objectif
     * @param objectif
     * @param prop1
     * @param prop2
     * @return IntCoordinates
     */
    public static IntCoordinates manhattan(IntCoordinates objectif,
                                           IntCoordinates prop1, IntCoordinates prop2)
    {
        if ((prop1.estEgal(new IntCoordinates(14,7))) ||
                (prop1.estEgal(new IntCoordinates(0,7)))) 
        {
            return prop2;
        }
        
        if ((prop2.estEgal(new IntCoordinates(14,7))) ||
                (prop2.estEgal(new IntCoordinates(0,7))))
        {
            return prop1;
        }
    ...
    public static IntCoordinates manhattan(IntCoordinates objectif,
                                           IntCoordinates prop1, IntCoordinates prop2, IntCoordinates prop3)
    {
    ...
    /**
     * retourner les coordonnées juste à côté de "co" pour que l'entité puisse s'y deplacer sans probleme
     * @param co
     * @param dir
     * @return
     */
